...
const mockStudy: CaseStudy = {
  ...
  processNarrative: [
    { phase: 'goals', description: 'Conducted user interviews.', assets: [] },
    { phase: 'solution', description: 'Created wireframes.', assets: [] },
    { phase: 'flow', description: 'Designed high-fidelity mockups.', assets: [] },
    { phase: 'system', description: 'Built the component.', assets: [] },
  ],
